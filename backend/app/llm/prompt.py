...
✅ 良い例: 「作業開始時において、担当者は安全確認を行う。」（状況と主体が明確）
✅ 良い例: 「異常が検出された場合、担当者は対応手順を実行し、その後結果を確認する。」（状況・行為・確認が明確）
...
- 「作業開始時において、担当者は安全確認を行う」→ 文脈が明確（タイミング、主体が明確）
- 「異常が検出された場合、担当者は対応手順を実行し、その後結果を確認する」→ より具体的な文脈（状況・行為・確認が明確）

...
T4: 「【タイミング・場面】において、【主体】は【基本ルール】に従って【行為】を行う。」
  例: 「作業開始時において、担当者はマニュアルに従って確認手順を実行する。」

【中級】
T6: 「【条件】の場合、【主体】は【行為】を行い、その後【確認】を行う。」
  例: 「特定の条件が満たされた場合、担当者は対応を行い、その後結果を確認する。」
T7: 「【操作】の前に【主体】は【前提条件・状況】を確認する必要がある。」
  例: 「作業を開始する前に、担当者は前提条件と状況を確認する必要がある。」
T8: 「【状況・条件】の場合、【主体】は【行為】を行う。その理由は【理由】である。」
  例: 「特定の状況において、担当者は対応を行う。その理由は、安全性を確保するためである。」
T9: 「【状況A】の場合は【主体】は【行為A】を行い、【状況B】の場合は【行為B】を行う。」
  例: 「通常時においては担当者は通常の手順を行うが、特別な状況においては追加の手順を行う。」

【上級】
T10: 「【条件・状況】がある場合、【主体】は【対応行為】を行う。」
  例: 「警報が発報した場合、担当者は対応手順を実行する。」
T11: 「【判断条件・状況】に該当する場合、【主体】は【対応】を行う必要がある。」
  例: 「特定の条件が満たされた状況に該当する場合、担当者は対応を行う必要がある。」
T12: 「【通常ケース・状況】では【主体】は【通常行為】を行うが、【例外条件・状況】の場合は【例外行為】を行う。」
  例: 「通常時においては担当者は通常の手順を行うが、例外条件が発生した場合は特別な手順を行う。」
...
2. 【必須】すべてのstatementには文脈（状況・条件・タイミング・場面）を含めること:
   ...
   - 状況: 異常が検出された場合、緊急時、通常時、特定の条件が満たされた場合など
...
- 「異常が検出された場合、担当者は対応手順を実行する」→ 文脈が明確（状況、主体が明確）
- 「緊急時において、特定の条件が満たされた場合、担当者は優先的に対応を行う」→ より具体的な文脈（状況、条件・主体が明確）
